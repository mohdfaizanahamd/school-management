...
<div class="wrapper row3">
  <div class="rounded">
    ...
    <div class="dv">
   <span><input type="hidden" id="key" name="key" placeholder="Merchant Key" value="" /></span>
    </div>
    
    <div class="dv">
   <span><input type="hidden" id="salt" name="salt" placeholder="Merchant Salt" value="" /></span>
    </div>
    ...
    <span><input type="text" id="amount" name="amount" placeholder="Amount"  /></span>    
    </div>
    
    <div class="dv">
   <span><input type="hidden" id="pinfo" name="pinfo" placeholder="Product Info" value="Fees" /></span>
    </div>
    
    <div class="dv">
    <span class="text"><label>Student Name:</label></span>
    ...
    <div class="dv">
    <span><input type="hidden" id="hidden" name="hash" placeholder="Hash" value="" /></span>
    </div>
...
//--
        ...
        <?php
          if(isset($_POST['submit'])){
            ...
            $q= $connection->query("insert into fees values('','$e1','$a1','$d1')");
            echo "Fees Submited";
          }
